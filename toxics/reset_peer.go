...
/*
This toxic behaves differently based on the stream direction,
upstream - will create the connection reset by peer, TCP RST
downstream - will initiate a graceful close by sending the FIN/ACK. (io.EOF)
 */
